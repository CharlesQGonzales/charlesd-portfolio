...
function skills () {
    return (
       ...
       <div className='grid lg:grid-cols-2 grid-cols-1'>
        <div className='block tracking-widest mb-10 lg:mb-0'>
...
<ul class="skill-secondary lg:flex grid grid-cols-4 gap-y-4 lg:justify-start ml-3 lg:ml-0 items-center h-full">
  <li class="skill-item-secondary lg:mx-8 mx-5 lg:w-11 w-10 h-11 flex justify-center items-center">
