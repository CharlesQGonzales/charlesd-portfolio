    ...
    return(
        ...
        <div className='flex flex-col lg:gap-10 gap-5'>
            ...
            .map((card_projects) => (
                ...
                <div>
                <img src={card_projects.image} alt='ulcollexWebsite' className='absolute lg:z-10 lg:w-[40%] w-[325px] rounded-md lg:rounded-[30px] border-1 cardShadow border-[#e8e8e8] lg:left-64 lg:-translate-y-[-10%]'/>
                </div>
